...
public class CardapioModel {
    public static String exibirCardapio() {
        ...
        try {
            ...
            while (rsSqlReceitas.next()) {
                ...
                if (receitaDisponivel == true) {
                    InterfacePadokaController.respReceitaDisponivel += "[" + numReceita + "] - " + nomeReceita + ".\n";
                    //System.out.println("[" + numReceita + "] - " + nomeReceita + " - disponível.");
                } else {
                    InterfacePadokaController.respReceitaIndisponivel += "[" + numReceita + "] - " + nomeReceita + ".\n";
        ...
        return InterfacePadokaController.respReceitaDisponivel;
    }
} 
